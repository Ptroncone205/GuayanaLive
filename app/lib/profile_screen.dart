                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (!isGuest) ...[
                      ...
                      if (!_isSetupMode)
                        _buildInfoField(
                          label: Translations.text(context, 'username'),
                          controller: _usernameController,
                        ),
                      _buildInfoField(
                        label: Translations.text(context, 'biography'),
                        controller: _bioController,
                        isBiography: true,
                      ),
                      _buildInfoField(
                        label: Translations.text(context, 'location'),
                        controller: _locationController,
                      ),
                      _buildInfoField(
                        label: Translations.text(context, 'website'),
